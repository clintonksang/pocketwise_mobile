...
class NotificationHandler(private val context: Context) {
    ...
    fun showExpenseNotification(amount: String, sender: String, question: String) {
        ...
        val actions = arrayOf("Needs", "Wants", "Savings/Investments", "Debt")
        actions.forEachIndexed { index, action ->
            ...
            notificationLayout.setOnClickPendingIntent(
                    context.resources.getIdentifier("button_$action", "id", context.packageName),
                    pendingIntent
            )
        }
...
//        val savingsIntent = Intent(baseIntent).apply { putExtra("action", "Savings and
// Investments") }
//        val debtIntent = Intent(baseIntent).apply { putExtra("action", "Debt") }
//
//        val needsPendingIntent = PendingIntent.getActivity(context, 0, needsIntent,
// PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
//        val wantsPendingIntent = PendingIntent.getActivity(context, 1, wantsIntent,
// PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
//        val savingsPendingIntent = PendingIntent.getActivity(context, 2, savingsIntent,
// PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
//        val debtPendingIntent = PendingIntent.getActivity(context, 3, debtIntent,
// PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
//
...
//            .setContentText(question)
//            .setPriority(NotificationCompat.PRIORITY_HIGH)
//            .setContentIntent(needsPendingIntent)  // Default intent when the notification is
// clicked
