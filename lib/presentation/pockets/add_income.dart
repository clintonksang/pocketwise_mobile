...
import 'package:pockets/provider/dropdown_provider.dart';
...
//                         (income) => income.income_from == sourceController.text)) {
//                       showDialog(
//                         context: context,
//                         builder: (ctx) {
//                           return AlertDialog(
...
//                 // Income amount field
//                 Text("income.i_earn".tr()).smallLight(),
//                 SizedBox(height: heightPadding),
//                 CustomTextField(
//                   controller: amountEditingController,
//                   hint: 'pockets.eg1000'.tr(),
...
//                 // Income source field
//                 Text("income.from_source".tr()).smallLight(),
//                 SizedBox(height: heightPadding),
//                 CustomTextField(
//                   controller: sourceController,
//                   hint: 'income.from'.tr(),
...
//                 // Frequency dropdown
//                 Text("income.every".tr()).smallLight(),
//                 SizedBox(height: heightPadding),
//                 CustomTextField(
//                   controller: categoryController,
//                   hint: dropdownProvider.selectedValue ?? 'income.frequency'.tr(),
...
//                   color: Colors.white,
//                   text: 'income.add_another'.tr(),
//                   onPressed:    saveentries(dropdownProvider)
//                 ),
//                 SizedBox(height: MediaQuery.of(context).size.height * .20),
...
//                 //       // Save the current income and navigate back
//                 //       incomeRepository.saveTransaction(newIncome);
//                 //       Navigator.pop(context);
//                 //     }
//                 //   },
