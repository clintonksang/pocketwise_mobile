  ...
  Widget build(BuildContext context) {
    return   AuthPageManager(
      ...
      children: Column(
        ...
        isPhoneSelected ? Phonefield() :  CustomTextField(
              controller: phoneController,
              hint: isPhoneSelected ? "register.hint_phone".tr() : "register.hint_email".tr(),
              title: isPhoneSelected ? "login.phone".tr() : "login.email".tr(),
